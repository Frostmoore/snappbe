...
{
    public function test_warm_populates_articles_newsletters_and_events_cache(): void
    {
        config(['snapp.wordpress.base_url' => 'https://sna.test']);
        Http::fake([
            '*/snapp/v1/events*' => Http::response(
                [['id' => 7, 'title' => 'Convegno', 'slug' => 'convegno']],
                200,
        ...
        $this->assertNotNull(Cache::get(EventCache::key('index:p1:pp20')));
    }
}
