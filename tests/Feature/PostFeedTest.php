...
class PostFeedTest extends TestCase
{
    ...
    {
        Post::create(['type' => 'news', 'title' => 'Pubblico', 'slug' => 'pub', 'status' => 'published', 'published_at' => now()->subDay(), 'min_level' => null]);
        Post::create(['type' => 'news', 'title' => 'Riservato', 'slug' => 'ris', 'status' => 'published', 'published_at' => now()->subDay(), 'min_level' => 'iscritto']);
        Post::create(['type' => 'news', 'title' => 'Bozza', 'slug' => 'boz', 'status' => 'draft', 'min_level' => null]);
    }
    ...
    public function test_show_reserved_post_forbidden_for_anonymous(): void
    {
        $this->levels();
        $post = Post::create(['type' => 'news', 'title' => 'R', 'slug' => 'r', 'status' => 'published', 'published_at' => now()->subDay(), 'min_level' => 'premium']);
    ...
    {
        $post = Post::create(['type' => 'news', 'title' => 'P', 'slug' => 'p', 'body' => '<p>ciao</p>', 'status' => 'published', 'published_at' => now()->subDay()]);
